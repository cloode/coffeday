...
class Comments(models.Model):
    ...
    star_count = models.CharField(max_length=120, choices=RATING_CHOICE, default=RATING_NEUTRAL, verbose_name="Рейтинг")
...
class UserProfile(models.Model):
    ...
    picture = models.ImageField(upload_to='profile/pictures/', default='default-profile.jpg', blank=True)
    quote = models.CharField(max_length=350, blank=True, null=True, verbose_name="Описание/Цитата")
    location = models.CharField(max_length=40, choices=LOCATION_SELECT, default='NO', verbose_name="Страна")
